...
--2.Find person name of the person from vid = 1003--
SELECT vid, vName
...
CREATE TABLE AGE(
    ...
    vAge int,
    PRIMARY KEY(vid),
    FOREIGN KEY(vid) REFERENCES cs411233.Veterinarians (vid)
);
-------------------------------------------
...
GRANT SELECT, UPDATE ON Age_View TO cs411233;
----------------------------------------------
--Testing--
...
DELETE FROM cs411233.Veterinarians WHERE vid = '1007';
...
REVOKE UPDATE ON Age_View FROM cs411233;
--Testing--
--1.Update VIEW(View_Age) with new values--
UPDATE cs411247.Age_View SET vAge = 55 WHERE vid = 1003;
UPDATE cs411247.Age_View SET vAge = 40 WHERE vid = 1005;
